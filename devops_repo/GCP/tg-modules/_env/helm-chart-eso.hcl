...
locals {
  ...
  eso_chart_name                    = local.env_vars.locals.eso_chart_name
  eso_chart_version                 = local.env_vars.locals.eso_chart_version
  eso_chart_repository              = local.env_vars.locals.eso_chart_repository
  eso_values_file_path              = local.env_vars.locals.eso_values_file_path
...
inputs = {
  ...
  chart                       = local.eso_chart_name
  chart_version               = local.eso_chart_version
  repository                  = local.eso_chart_repository
  values_file_path            = local.eso_values_file_path
}